...
public class TablaInformes extends javax.swing.JDialog {
    ...
    /**
     * Carga los informes PDF generados en la carpeta "informesPDFGenerados" y los muestra en la tabla.
     * Si la carpeta no existe, se crea automáticamente.
     * Cada fila de la tabla muestra el nombre del informe, su tipo, la fecha de creación y la ruta del archivo (oculta).
     */
    ...
    /**
     * Determina el tipo de informe basado en el prefijo del nombre del archivo.
     *
     * @param nombreArchivo El nombre del archivo del informe.
     * @return Una cadena que representa el tipo de informe.
     */
    ...
    /**
     * Abre el informe PDF seleccionado en la tabla. El tipo de informe se determina por el prefijo del nombre del archivo.
     * Si el informe es de avería, se extrae el ID de avería del nombre del archivo y se muestra el informe correspondiente.
     * Si el informe es de estado de maquinaria, se extrae el ID de estado del nombre del archivo y se muestra el informe correspondiente.
     * Si el informe es de rendimiento técnico, se muestra el informe correspondiente sin necesidad de extraer un ID.
     * Si el tipo de informe no es soportado, se muestra un mensaje de error.
     */
    ...
    /**
     * Elimina el informe PDF seleccionado en la tabla. Se solicita confirmación al usuario antes de eliminar el archivo.
     * Si el archivo no existe o ya fue eliminado, se muestra un mensaje de advertencia y se recarga la lista de informes.
     * Si la eliminación es exitosa, se muestra un mensaje de confirmación y se recarga la lista de informes.
