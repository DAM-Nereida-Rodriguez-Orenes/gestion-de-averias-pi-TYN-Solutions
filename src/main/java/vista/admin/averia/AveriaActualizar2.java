 ...
 * @author Netri
 */
public class AveriaActualizar2 extends javax.swing.JDialog {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(AveriaActualizar2.class.getName());
     ...
     */
    public AveriaActualizar2(java.awt.Frame parent, boolean modal, Averia averiaSeleccionada) {
        super(parent, modal);
        initComponents();
